...
<img width="1280" height="698" alt="모니멘툼로고" src="https://github.com/user-attachments/assets/79a761b4-8941-4cde-ab6d-a589c660d9b6" />

# Monimentoom Server

> 나만의 굿즈로 꾸미는 가상 방 — 모니멘툼 백엔드 API 서버
...
<!-- [이미지] 전체 시스템 아키텍처 다이어그램 (프론트엔드 ↔ Nginx ↔ Spring App ↔ MySQL/S3) -->
...
<!-- [이미지] ERD 다이어그램 (users, rooms, goods, positions, likes, comments, refresh_tokens 테이블) -->
