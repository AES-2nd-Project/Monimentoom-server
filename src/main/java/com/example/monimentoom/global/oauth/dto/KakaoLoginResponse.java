...
public record KakaoLoginResponse(
    ...
    public static KakaoLoginResponse ofExistingUser(String token, String refreshToken, Long userId, String nickname, String email) {
        return new KakaoLoginResponse(null, token, refreshToken, userId, nickname, email);
    }
